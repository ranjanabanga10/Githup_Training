...
public class TestC26_newviewContact 
{
	static WebElement driver;
	
	@Test
	public static void newViewContact()
	{
		...
		viewName.sendKeys("Business_View");
		WebElement uniqueViewName=driver.findElement(By.xpath("//input[@id='devname']"));
		uniqueViewName.sendKeys("Business_Owner");
		WebElement saveContact=driver.findElement(By.xpath("//div[@class='pbBottomButtons']//input[@name='save']"));
		saveContact.click();
	}
