...
public class TestC28_myContactView 
{
	static WebDriver driver;
	@Test
	public static void myContactView()
	{
		...
		WebElement viewContact=driver.findElement(By.xpath("//select[@id='fcf']"));
		Select sel=new Select(viewContact);
