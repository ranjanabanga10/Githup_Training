...
public class TestC32_chkSaveNewbtnContactPage 
{
	static WebDriver driver;
	@Test
	public static void chkSaveNewbtnContactPage()
	{
		...
		WebElement saveNewContact=driver.findElement(By.xpath("//td[@id='topButtonRow']//input[contains(@name,'save_new')]"));
