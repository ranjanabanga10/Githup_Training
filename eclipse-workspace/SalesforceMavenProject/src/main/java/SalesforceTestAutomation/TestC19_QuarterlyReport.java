...
public class TestC19_QuarterlyReport 
{
	static WebDriver driver;
	@Test
	public static void quarterReport()
	{
		...
		WebElement intervalopty=driver.findElement(By.xpath("//select[@id='quarter_q']"));
		intervalopty.click();
		WebElement openopty=driver.findElement(By.xpath("//select[@id='open']"));
		openopty.click();
	}
}
